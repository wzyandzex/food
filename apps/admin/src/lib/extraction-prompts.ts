...
示例：
{"title":"西红柿炒鸡蛋","servings":2,"difficulty":1,"minutes":15,"tags":["家常","快手"],"ingredients":[{"name":"鸡蛋","qty":3,"unit":"个","optional":false},{"name":"盐","qty":2,"unit":"克","optional":true}],"steps":[{"text":"西红柿切块，鸡蛋打散","durationMinutes":5},{"text":"先炒蛋盛出，再炒西红柿，最后混合出锅","durationMinutes":8}]}`
